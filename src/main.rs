//! # A Solidity REPL
//!
//! This is a work in progress! See the list of features below [at the bottom of the README](#features).
//!
//! ## Installation
//!
//! Get rust with [rustup](https://rustup.rs/) and then run `cargo install soli`
//!
//!
//! ## Usage
//!
...
impl<'a> ConstructedSource<'a> {
    ...
    fn clear_constructor(&mut self) -> &mut Self {
        self.constructor = Default::default();
        self.cached_compiled = None;
        self
    }
